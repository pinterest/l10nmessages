...
public enum TestMessages2 {
  hello_user("hello_user");

  public static final String BASENAME = "com.pinterest.l10nmessages.L10nPropertiesProcessorTest_IO.repeatableJava9.TestMessages2";
  public static final String MESSAGE_FORMAT_ADAPTER_PROVIDERS = "AUTO";

  private String key;

  TestMessages2(String key) {
    this.key = key;
  }
