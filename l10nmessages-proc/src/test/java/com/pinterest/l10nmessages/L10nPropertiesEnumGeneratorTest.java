        ...
        .isEqualTo(
            String.format(
                "package com.pinterest.l10nmessages;\n"
                    ...
                    + "  }\n"
                    + "\n"
                    + "  static class FC_hello_username implements FormatContext<Messages> {\n"
                    ...
                    + "    }\n"
                    + "\n"
                    + "    FC_hello_username count(Object value) {\n"
                    + "      map.put(\"count\", value);\n"
                    + "      return this;\n"
                    + "    }\n"
                    + "\n"
                    + "    FC_hello_username userName(Object value) {\n"
                    + "      map.put(\"userName\", value);\n"
                    + "      return this;\n"
                    + "    }\n"
                    + "  }\n"
                    + "\n"
                    + "  static FC_hello_username hello_username() {\n"
