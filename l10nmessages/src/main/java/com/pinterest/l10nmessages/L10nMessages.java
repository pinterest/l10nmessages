 ...
 * {@code properties} file and to apply build time checks to its messages.
 *
 ...
 *     Maven plugin). If not, it can be any type. If {@link String} is used, the message loading will be
 *     similar to plain Java.
