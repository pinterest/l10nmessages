...
javac -d outputproc -proc:only \
  -processorpath "src/main/resources:../../l10nmessages-proc/target/l10nmessages-proc-1.0.0.jar:../../l10nmessages/target/l10nmessages-1.0.0.jar" \
...
javac -d output -proc:none -classpath "outputproc:../../l10nmessages/target/l10nmessages-1.0.0.jar" \
  src/main/java/com/pinterest/l10nmessages/example/Application.java

# We need the jar file and the resources at runtime in addition to the compiled application
java -cp "src/main/resources/:output:../../l10nmessages/target/l10nmessages-1.0.0.jar" \
