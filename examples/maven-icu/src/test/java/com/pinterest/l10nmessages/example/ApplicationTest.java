...
class ApplicationTest {
  ...
  void youHaveMessagesEnglish() {
    assertIterableEquals(
        Arrays.asList("You have 0 messages", "You have 1 message", "You have 2 messages"),
  ...
  void youHaveMessagesFrench() {
    assertIterableEquals(
        Arrays.asList("Vous avez 0 message", "Vous avez 1 message", "Vous avez 2 messages"),
  ...
  void youHaveMessagesJapanese() {
    assertIterableEquals(
        Arrays.asList("メッセージが 0 件", "メッセージが 1 件", "メッセージが 2 件"),
